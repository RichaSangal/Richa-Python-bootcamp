...
full_message = name + surname +  "is"  + str(age) + " years old" #Runtime error; 'age' needs to be cast to a str() + # Compilation error; 'is' is under the wrong syntax, needs to be within " "  
