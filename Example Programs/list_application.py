...
index = 0
right = 0  # A count variable to track how many questions the user answers correctly
while index < len(questions):  # Run through the questions and count how many are answered correctly
